...
NOTEBOOK_PATH = "/Users/raj/PycharmProjects/VedaGPT/continuousPreTrainStyle/qlorafinetunev2.ipynb"
...
cells = [
    {
        ...
        "source": [
            ...
            "\n",
            "This notebook adapts the Unsloth QLoRA continuous pretraining workflow for **Modal Infrastructure**.\n",
            "It is configured to run on an **NVIDIA L40S GPU (48GB VRAM)**, with **2 CPU cores**, and **32GiB RAM**.\n",
            "\n",
            "### Prerequisites\n",
            "1. You need a Modal account. Sign up at [modal.com](https://modal.com).\n",
            "2. Make sure you have local access to `data/continueousPreTrainData.jsonl`."
        ]
    },
    {
        "cell_type": "code",
        ...
        "outputs": [],
        "source": [
            "# Install the Modal package locally if you haven't already\n",
            "!pip install modal"
        ]
    },
    {
        ...
        "metadata": {},
        "source": [
            "### Alternative: Create a Clean Local Virtual Environment\n",
            "If you run into local `protobuf`, `gRPC`, or other package conflicts (e.g., `TypeError` when executing `.remote()`), we recommend creating a fresh local environment using `uv`:\n",
            "\n",
            "```bash\n",
            ...
            "```\n",
            "\n",
            "Once created, select the `.venv` kernel in your Jupyter environment before running the remaining cells."
        ]
    },
    {
        "cell_type": "markdown",
        ...
        "source": [
            ...
            "Run the following command to authenticate your local environment with Modal."
        ]
    },
    {
        "cell_type": "code",
    ...
    },
    {
        ...
        "metadata": {},
        "source": [
            "### Define Modal App, Mounts, and Volumes\n",
            "We define the Modal App and the shared persistent storage volumes. We'll use one volume for caching the Hugging Face base models and another for training checkpoints."
        ]
    },
    {
        "cell_type": "code",
    ...
    },
    {
        ...
        "source": [
            ...
            "We build a custom container image with CUDA-compatible Unsloth and all required training dependencies. We'll use PyTorch 2.7.0 and CUDA 12.8 optimizations.\n",
            "The training data is mounted into the image as the final build step to optimize build caching."
        ]
    },
    {
        "cell_type": "code",
        ...
        "source": [
            ...
            "    .add_local_file(\n",
            "        \"data/continueousPreTrainData.jsonl\",\n",
    ...
    },
    {
        ...
        "metadata": {},
        "source": [
            "### Helper Functions (Pre-processing & Tokenization)\n",
            "We define the helper functions for token-level chunking and pretraining data formatting."
        ]
    },
    {
        "cell_type": "code",
    ...
    },
    {
        ...
        "source": [
            ...
            "This function is decorated with `@app.function` to execute in Modal's cloud environment. \n",
            "We specify the NVIDIA L40S GPU, 2 CPU cores, and 32GiB RAM. The function loads the model, targets layers using PEFT, pre-processes the data, and runs the pretraining loop."
        ]
    },
    {
        "cell_type": "code",
        ...
        "source": [
            ...
            "            max_seq_length = max_seq_length,\n",
            "            dataset_num_proc = 2,  # Align with 2 CPU cores\n",
            "            packing = False,\n",
    ...
    },
    {
        ...
        "metadata": {},
        "source": [
            "### Run Remote Pretraining\n",
            "Execute the training job on Modal's cloud infrastructure. This will automatically stream logs to the output below."
        ]
    },
    {
        "cell_type": "code",
    ...
    },
    {
        ...
        "metadata": {},
        "source": [
            "### Define the Remote Inference Function\n",
            "Define a remote function to verify the model by completing Vedic text prompts and answering chat queries."
        ]
    },
    {
        "cell_type": "code",
    ...
    },
    {
        ...
        "source": [
            "### Run Inference Tests\n",
            "Execute the inference evaluation suite remotely on Modal's L40S GPU."
        ]
    },
    {
        "cell_type": "code",
    ...
    },
    {
        ...
        "metadata": {},
        "source": [
            "### Define the Deploy and GGUF Export Function\n",
            "This function loads the trained adapters, pushes them to Hugging Face, saves the merged 16-bit model, and exports the model to GGUF format for local use."
        ]
    },
    {
        "cell_type": "code",
        ...
        "source": [
            ...
            "    model, tokenizer = FastLanguageModel.from_pretrained(\n",
            "        model_name = model_path,\n",
            "        max_seq_length = 16384,  # Match the trained context\n",
    ...
    },
    {
        ...
        "metadata": {},
        "source": [
            "### Run Push and GGUF Export\n",
            "Execute the upload and export job remotely on Modal."
        ]
    },
    {
        "cell_type": "code",
...
# Write the new notebook contents
with open(NOTEBOOK_PATH, "w", encoding="utf-8") as f:
    json.dump(notebook, f, indent=2, ensure_ascii=False)

print("✅ Notebook modified successfully for Modal!")
